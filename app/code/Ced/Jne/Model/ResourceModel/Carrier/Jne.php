 ...
 * CedCommerce
  ...
  */
namespace Ced\Jne\Model\ResourceModel\Carrier;
...
class Jne extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
 ...
 //   protected $_importUniqueHash = [];
    ...
    public function __construct(
        ...
        \Ced\Jne\Model\Carrier\Jne $carrierTablerate,
    ...
    public function getRates(\Magento\Quote\Model\Quote\Address\RateRequest $request)
    {
        ...
        $condition = $this->_coreConfig->getValue('carriers/jne/ratecondition', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        ...
        $methods = array();
        $rates = array();
        $weight_type = $this->_coreConfig->getValue('carriers/jne/weight_type', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        ...
        $dimensional_condition = $this->_coreConfig->getValue('carriers/jne/dimensional_calculation', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
...
$logger->info("-----Result RATES------ :".json_encode($rates));
    ...
    public function uploadAndImport(\Magento\Framework\DataObject $object)
    {
        ...
        if (empty($_FILES['groups']['tmp_name']['jne']['fields']['import']['value'])) {
            return $this;
        }
        $csvFile = $_FILES['groups']['tmp_name']['jne']['fields']['import']['value'];
 ...
 //       $this->_importUniqueHash = [];
        ...
        if ($headers === false || count($headers) < 12) {
            $stream->close();
            throw new \Magento\Framework\Exception\LocalizedException(__('Please correct Jne Rates File Format.'));
        }
 ...
 */
     ...
     * @param array $data
     * @return \Ced\Jne\Model\Resource\Carrier\Jne
     */
