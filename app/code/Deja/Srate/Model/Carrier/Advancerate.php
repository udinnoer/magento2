 ...
 * CedCommerce
  ...
  */
namespace Deja\Srate\Model\Carrier;

use Magento\Framework\Exception\LocalizedException;
use Magento\Quote\Model\Quote\Address\RateRequest;

class Srate extends \Magento\Shipping\Model\Carrier\AbstractCarrier implements
    \Magento\Shipping\Model\Carrier\CarrierInterface
{

    protected $_code = 'srate';
    ...
    /**
     * @var \Deja\Srate\Model\Resource\Carrier\SrateFactory
     */
    ...
    public function __construct(
        ...
        \Deja\Srate\Model\ResourceModel\Carrier\SrateFactory $tablerateFactory,
        array $data = []
    ) {
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        //$listcategory = '["4","5"]';
        $listcategory = $this->_scopeConfig->getValue('carriers/srate/notcategory', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
       ...
       // print_r($rates);echo "admin";
        if ($shippingenable && 
            $this->_scopeConfig->getValue('carriers/srate/free_shipping', \Magento\Store\Model\ScopeInterface::SCOPE_STORE) && 
        		($request->getFreeShipping() === true || 
        		($request->getPackageValue() >= $this->_scopeConfig->getValue('carriers/srate/min_freeshipping_amount', \Magento\Store\Model\ScopeInterface::SCOPE_STORE) && 
        		$request->getPackageWeight() <= $this->_scopeConfig->getValue('carriers/srate/max_freeshipping_weight', \Magento\Store\Model\ScopeInterface::SCOPE_STORE))))
          {
        	
        	$method = $this->_rateMethodFactory->create();
        	$method->setCarrier($this->_code);
        	$method->setCarrierTitle("Ship Rate");
